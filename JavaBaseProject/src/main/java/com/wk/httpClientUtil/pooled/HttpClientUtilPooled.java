...
import com.wk.httpClientUtil.HttpDeleteWithEntity;
import com.wk.httpClientUtil.HttpMethods;
import com.wk.httpClientUtil.JSONUtil;
...
public class HttpClientUtilPooled {
    private static final Logger logger = LoggerFactory.getLogger(HttpClientUtilPooled.class);
